      ...
      <Provider store={store}>
        <>
          ...
          <main className="application-content">
            <Switch>
              <Route path='/challenges/all' component={this.web3AllTokens} />
              <Route path='/challenges/purchased' component={this.web3PurchaseHistory} />
              <Route path='/challenges/new' component={this.web3CustomizeToken} />
