          ...
          <Hero>
            <div className="columns">
              ...
              <div className="column is-two-thirds">
                ...
                <h2 className="subtitle">
                  To use the platform you will need to install the <a href='https://metamask.io/' title='MetaMask' target='_blank'>MetaMask</a> extension for Chrome, Firefox or Brave desktop browsers:
                </h2>
